            ...
            <Hero isFullHeight isColor={theme} isSize="medium">
                ...
                <div className="container py-4">
                    ...
                    <div className="pl-3">
                        ...
                        <b>Whether we are participating as professionals or volunteers, we value professionalism in all interactions and take responsibility for our own speech. Be kind to others. Do not insult or put down other participants. Harassment and other exclusionary behavior are not acceptable. This includes, but is not limited to</b>
                    ...
                    <ol className="pl-4">
                        <li>Do not quote messages that were sent to you by other people in private query, unless agreed beforehand.    </li>

                        <li>If you want to explain to someone how to use IRC, do it privately.    </li>

                        <li>Never send messages with colours (i.e. colour codes); use plain text instead.    </li>

                        <li>Do not send "test" messages to determine whether your IRC client is working. We have a #test channel for that.</li>
                    </ol>
                    ...
                    <ol className="pl-4">
                        ...
                        <li>Respect the <a href="http://chris.beams.io/posts/git-commit/">correct commit log style</a>.</li>

                        <li>When you would like to have new changes to be in the project, please do a pull-request which can be reviewed by the mentors before being merged into the project.</li>
                    </ol>
                </div>
            </Hero>
        </Layout>
