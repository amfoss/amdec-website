...
`;
    ...
    const register = () => {
        ...
        if (name === '' || phone === '' || email === '' || gender === ''|| age === ''|| university === ''|| githubusername === ''|| institution === ''|| time ===''|| impact ===''|| about ===''|| project===''|| description===''|| currentState===''|| expectation==='') {
            setLoading(false);
            ...
            const json = { gender, age, university,time,impact,about,expectation, description,githubusername, currentState};
                            ...
                            <div className={`forms card`}>
                                ...
                                <div className="row m-0 px-4 pb-4">
                                    ...
                                    <div className="col-sm-6 p-0">
                                        <div className="m-2">
                                            <label>Project *</label>
                                            <select className="form-control text-dark" onChange={e => setProject(e.target.value)}>
