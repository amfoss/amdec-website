...
const Contact = () => {
    ...
    return(
        <Hero id="contact" isColor={theme}>
            <Title className="has-text-centered" style={{fontWeight: '900'}}>Contact Us</Title>
            <HeroBody>
                    ...
                    <div className="col-lg-4 p-4">
                        ...
                        <div className="row m-4 p-4">
                            <div className="has-text-centered">
                                ...
                                <p className="pt-2">Join us on the IRC channel #amfoss-amdec on Freenode! If you don't have IRC set up you can easily connect from your web browser too.</p>
                            </div>
                        </div>
                    </div>
                </div>
